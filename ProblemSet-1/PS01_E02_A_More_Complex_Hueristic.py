...
def complex_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        passenger_id = passenger['PassengerId']
        predictions[passenger_id] = True if passenger['Sex'] == "female" or (passenger['Age'] < 18 and passenger['Pclass'] == 1) else False
    ...
    print collections.Counter(accuracy)[True]/float(len(accuracy))*100.
    return predictions
